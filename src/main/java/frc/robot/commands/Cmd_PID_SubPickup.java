...
public class Cmd_PID_SubPickup extends CommandBase {

    private final Sub_Elbow m_sub_Elbow;
    private final Sub_Shoulder m_sub_Shoulder;

    public Cmd_PID_SubPickup(Sub_Elbow elbowSubsystem, Sub_Shoulder shoulderSubsystem) {
    ...
    @Override
    public void execute() {
        m_sub_Elbow.Elbow_PID_SubPickup();
        m_sub_Shoulder.Shoulder_PID_SubPickup();
    }
