...
public class Cmd_PID_GroundPickup extends CommandBase {
    private final Sub_Elbow m_sub_Elbow;
    private final Sub_Shoulder m_sub_Shoulder;


    public Cmd_PID_GroundPickup(Sub_Elbow elbowSubsystem, Sub_Shoulder shoulderSubsystem) {
    ...
    @Override
    public void execute() {
        m_sub_Elbow.Elbow_PID_GroundPickup();
